<template>
    <div class="w-full">
        <crud-view
            ...
            :pagination="$store.getters.plantPaginator"
        >
                ...
                <div class="flex flex-col gap-4 mt-2">
                    ...
                    <div class="grid grid-cols-6 gap-6 mt-2">
                        <div class="col-span-6">
                            ...
                            <textarea  name="nutrient_schedule" id="nutrient_schedule" class="h-24 mt-1 py-2 px-4 border focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 dark:border-gray-600 dark:bg-slate-500 rounded-md" />
                        </div>
                    </div>
                    <div class="grid grid-cols-6 gap-6 mt-2">
                        <div class="col-span-6">
                            <label for="settings" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Settings</label>
                            <textarea name="settings" id="settings" class="h-24 mt-1 py-2 px-4 border focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 dark:border-gray-600 dark:bg-slate-500 rounded-md" />
                        </div>
                    </div>
                </div>
            </template>
